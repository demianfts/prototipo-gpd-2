        ...
        return (
            <div >                 
                 ...
                 onMouseLeave={() => this.cambiarColor("white")}>
                     <img className="fotoPerfil" width="190" height="190" src={this.props.info.picture.large} alt=""/>
                     ...
                     <br></br>
                        ...
                        <button type="button" className="btn btn-success dropdown-toggle" id="botonTarjeta" data-bs-toggle="dropdown" aria-expanded="false">Ver detalle </button>
